    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="p-6 space-y-5 max-w-5xl w-full">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: 'Team Members', value: '24', sub: '↑ 2 this month', icon: '👥', color: 'text-blue-400', border: 'border-blue-500/30', bg: 'from-blue-500/10 to-transparent' },
            { label: 'Work Output', value: '92%', sub: '↑ 5% vs last month', icon: '📊', color: 'text-green-400', border: 'border-green-500/30', bg: 'from-green-500/10 to-transparent' },
            { label: 'Pending Tasks', value: '8', sub: '↓ 3 from last week', icon: '📋', color: 'text-yellow-400', border: 'border-yellow-500/30', bg: 'from-yellow-500/10 to-transparent' },
          ].map((kpi) => (
            <div key={kpi.label} className={`bg-gradient-to-br ${kpi.bg} border ${kpi.border} rounded-2xl p-5`}>
